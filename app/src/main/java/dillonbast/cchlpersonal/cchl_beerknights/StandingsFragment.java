package dillonbast.cchlpersonal.cchl_beerknights;
...
public class StandingsFragment extends Fragment {
    ...
    private class JsoupRun extends AsyncTask<Void, Void, Void> {
        String url = "http://stats.adultrechockey.ca/c-regina/ashnregina/en/stats/statdisplay.php?type=standings&subType=7&season_id=76&tournament_id=0&leagueId=6&division_id=254&confId=0&team_id=3642";
        Elements leftAlign;
