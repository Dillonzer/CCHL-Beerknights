...
public class RosterFragment extends Fragment {
    ...
    private class JsoupRun extends AsyncTask<Void, Void, Void> {
        String url = "http://stats.adultrechockey.ca/c-regina/ashnregina/en/stats/statdisplay.php?type=skaters&team_id=3506&season_id=76&tournament_id=0&leagueId=6&division_id=-1&confId=0";
